...
## 7.2 Offline Python analysis.

![](./images/final_q_values.png)


## 7.3 Acceptance Rate Over Time

![](./images/acceptance_rate.png)

## 7.4 Unique Actions Learned

![](./images/unique_actions.png)

## 7.5 Q-Value by Action
...
-   Card, Moran, Newell. The Psychology of Human-Computer Interaction (1983) — Keystroke-Level Model.

-   Auer et al. (2002) — UCB bandits.

-   Langford & Zhang (2008) — Contextual bandits.

-   Productivity research in HCI and intelligent tutoring systems.
